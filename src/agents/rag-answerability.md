...
判断 RAG 检索结果是否真正服务当前 AnswerGoal，并萃取可用部分。它不直接回复用户、不新增事实，只输出结构化 answerability、covered claims、missing elements 和 escalation focus。
