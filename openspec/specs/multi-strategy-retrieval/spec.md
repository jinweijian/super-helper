...
Define the multi-strategy retrieval orchestration that fuses BM25 keyword recall, embedding semantic recall, taxonomy alias expansion, and rerank behind a single retrieval service interface.
