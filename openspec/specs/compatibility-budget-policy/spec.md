...
Define the compatibility budget policy that limits how much legacy behavior is preserved, so each compatibility shim is owned, bounded, and removable on a schedule.
