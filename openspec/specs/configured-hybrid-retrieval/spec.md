...
Define the configured hybrid retrieval path that fuses BM25 and embedding under fixed candidate budgets, applies metadata filters before similarity, and keeps a safe rerank fallback.
