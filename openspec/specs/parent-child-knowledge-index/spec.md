...
Define the parent-child knowledge index that splits published parents into bounded child chunks with deterministic ids, parent lookup, and rebuildable vectors.
