...
Define the knowledge CLI command decomposition that splits command tree, argument parsing, transport output, knowledge service calls, and compatibility shim ownership into separate modules.
