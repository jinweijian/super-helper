...
Define the local knowledge module boundaries that separate knowledge indexing, retrieval call sites, and presentation-only data from each other and from runtime and gateway modules.
