...
Define the CLI command boundary that keeps argument parsing, command tree, and transport-only output separate from retrieval strategy selection, provider construction, and runtime diagnostic decisions.
