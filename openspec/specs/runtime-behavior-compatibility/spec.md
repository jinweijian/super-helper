...
Define the runtime behavior compatibility contract that the decomposed runtime services must preserve so existing diagnostic flow behavior does not change.
